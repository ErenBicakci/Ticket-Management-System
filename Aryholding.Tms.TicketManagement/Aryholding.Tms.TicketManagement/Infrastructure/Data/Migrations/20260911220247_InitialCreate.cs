        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriorityLevelCode = table.Column<string>(type: "text", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                name: "TicketEventTypes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    EventTypeCode = table.Column<string>(type: "text", nullable: false),
                    DisplayName = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketEventTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TicketSeverityCode = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TicketStatusCode = table.Column<string>(type: "text", nullable: false),
                    Name = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(type: "text", nullable: false),
                    TicketCategoryCode = table.Column<string>(type: "text", nullable: false),
                    DepartmentId = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketCategories_PriorityLevels_PriorityLevelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDepartmentRoles", x => x.UserRoleId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDepartmentRoles_PriorityLevels_PriorityLevelId",
                        column: x => x.PriorityLevelId,
                        principalTable: "PriorityLevels",
                        principalColumn: "PriorityLevelId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TicketId = table.Column<long>(type: "bigint", nullable: false),
                    TicketEventTypeId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketHistories_TicketEventTypes_TicketEventTypeId",
                        column: x => x.TicketEventTypeId,
                        principalTable: "TicketEventTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "TicketEventTypes",
                columns: new[] { "Id", "DisplayName", "EventTypeCode" },
                values: new object[,]
                {
                    { 1, "Oluşturuldu", "CREATED" },
                    { 2, "Durum Değişti", "STATUS_CHANGED" },
                    { 3, "Öncelik Değişti", "PRIORITY_CHANGED" },
                    { 4, "Atanan Kişi Değişti", "ASSIGNEE_CHANGED" },
                    { 5, "İçerik Değişti", "TITLE_CHANGED" },
                    { 6, "Ek Eklendi", "ATTACHMENT_ADDED" },
                    { 7, "Ek Kaldırıldı", "ATTACHMENT_REMOVED" },
                    { 8, "Yeniden Açıldı", "REOPENED" },
                    { 9, "Sistem Notu", "SYSTEM_NOTE" },
                    { 10, "Silindi", "DELETED" },
                    { 11, "Atama Kaldırıldı", "UNASSIGNED" },
                    { 12, "Güncellendi", "UPDATED" }
                });

            migrationBuilder.InsertData(
                table: "TicketSeverities",
                columns: new[] { "Id", "Name", "TicketSeverityCode" },
                values: new object[,]
                {
                    { 1, "Info", "INFO" },
                    { 2, "Low", "LOW" },
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "Beklemede", "PENDING" },
                    { 2, "Kabul Edildi", "ACCEPTED" },
                    { 3, "Onay Bekliyor", "WAITING_APPROVAL" },
                    { 4, "Onaylandı", "APPROVED" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketCategories_PriorityLevelId",
                table: "TicketCategories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistories_TicketEventTypeId",
                table: "TicketHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDepartmentRoles_PriorityLevelId",
                table: "UserDepartmentRoles",
                column: "PriorityLevelId");

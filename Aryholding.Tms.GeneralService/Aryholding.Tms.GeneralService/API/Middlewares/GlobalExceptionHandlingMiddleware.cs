...
namespace Aryholding.Tms.GeneralService.API.Middlewares
{
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            switch (exception)
            {
                ...
                case NotFoundException notFoundEx:
                    ...
                    response.Details = new { notFoundEx.ResourceName, notFoundEx.ResourceKey };
                    break;
                ...
                case Microsoft.EntityFrameworkCore.DbUpdateException dbUpdateEx:
                    ...
                    if (IsDevelopmentEnvironment())
                        response.Details = new { InnerException = dbUpdateEx.InnerException?.Message };
                    break;
